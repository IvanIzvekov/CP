...
class UtilsService:
    def __init__(
        self, user_repo: IUserRepository, schedule_repo: IScheduleRepository
    ):
    ...
    async def set_standard_posts(
        self, data: List[PostEntity]
    ) -> List[PostEntity]:
